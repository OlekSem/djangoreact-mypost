                    ...
                    <div className="flex flex-1 items-center justify-end md:justify-between">
                        <nav aria-label="Global" className="hidden md:block">
                            <ul className="flex items-center gap-6 text-sm">
                                <li>
                                    <a className="text-gray-500 transition hover:text-gray-500/75" href="/"> Cities </a>
                                </li>

                                <li>
                                    <a className="text-gray-500 transition hover:text-gray-500/75"
                                       href="/create"> Create a city </a>
                                </li>
                        ...
                        <div className="flex items-center gap-4">
                            <div className="sm:flex sm:gap-4">
                                ...
                                <a className="hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600 transition hover:text-teal-600/75 sm:block"
                                   href="#">
                                    Register
                                </a>
                            </div>
